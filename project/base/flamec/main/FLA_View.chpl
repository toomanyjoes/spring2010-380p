 ...
 *************************************************************************** */
def FLA_Part_2x2(A: FLA_Obj, A11: FLA_Obj, A12: FLA_Obj,
									  A21: FLA_Obj, A22: FLA_Obj,
					  mb: dim_t,  nb: dim_t   , quadrant: FLA_Quadrant): FLA_Error {
	var base: FLA_Base_obj;
	var m: dim_t;
	var n: dim_t;
	var offm: dim_t;
	var offn: dim_t;
  ...
  if ( quadrant == FLA_BL || quadrant == FLA_BR ) then mb = m - mb;
  if ( quadrant == FLA_TR || quadrant == FLA_BR ) then nb = n - nb;
...
def FLA_Part_2x1( A: FLA_Obj, A1: FLA_Obj, 
                              A2: FLA_Obj,
...
def FLA_Part_1x2( A: FLA_Obj, A1: FLA_Obj, A2: FLA_Obj,
                              nb: dim_t  , side: FLA_Side ): FLA_Error 
{
  if ( FLA_Check_error_level() == FLA_FULL_ERROR_CHECKING ) then
  ...
  if ( side == FLA_RIGHT ) then nb = A.n - nb;
...
def FLA_Repart_2x2_to_3x3( ATL: FLA_Obj, ATR: FLA_Obj, A00: FLA_Obj, A01: FLA_Obj, A02: FLA_Obj,
                                                       A10: FLA_Obj, A11: FLA_Obj, A12: FLA_Obj,
                           ABL: FLA_Obj, ABR: FLA_Obj, A20: FLA_Obj, A21: FLA_Obj, A22: FLA_Obj,
                           mb: dim_t,  nb: dim_t     , quadrant: FLA_Quadrant ): FLA_Error 
{
  if ( FLA_Check_error_level() == FLA_FULL_ERROR_CHECKING ) then
...
def FLA_Repart_2x1_to_3x1( AT: FLA_Obj,  A0: FLA_Obj,
                                         A1: FLA_Obj,
...
def FLA_Repart_1x2_to_1x3( AL: FLA_Obj,     AR: FLA_Obj,
                                            A0: FLA_Obj, A1: FLA_Obj, A2: FLA_Obj,
                           nb: dim_t  ,     side: FLA_Side ): FLA_Error 
{
  if ( FLA_Check_error_level() == FLA_FULL_ERROR_CHECKING ) then
...
def FLA_Cont_with_3x3_to_2x2( ATL: FLA_Obj, ATR: FLA_Obj,  A00: FLA_Obj, A01: FLA_Obj, A02: FLA_Obj,
                                                           A10: FLA_Obj, A11: FLA_Obj, A12: FLA_Obj,
                              ABL: FLA_Obj, ABR: FLA_Obj,  A20: FLA_Obj, A21: FLA_Obj, A22: FLA_Obj,
                                                           quadrant: FLA_Quadrant ): FLA_Error 
{
  if ( FLA_Check_error_level() == FLA_FULL_ERROR_CHECKING ) then
...
def FLA_Cont_with_3x1_to_2x1( AT: FLA_Obj,  A0: FLA_Obj,
                                            A1: FLA_Obj,
                              AB: FLA_Obj,  A2: FLA_Obj,
                                            side: FLA_Side): FLA_Error 
{
  if ( FLA_Check_error_level() == FLA_FULL_ERROR_CHECKING ) then
...
def FLA_Cont_with_1x3_to_1x2( AL: FLA_Obj,              AR: FLA_Obj,
                                           A0: FLA_Obj, A1: FLA_Obj, A2: FLA_Obj,
                                                                     side: FLA_Side): FLA_Error
{
  if ( FLA_Check_error_level() == FLA_FULL_ERROR_CHECKING ) then
